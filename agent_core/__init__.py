...
_LAZY_IMPORTS = {
    ...
    "Principal": "agent_core.principal",
    "ChannelIdentity": "agent_core.principal",
    "PrincipalResolver": "agent_core.principal",
    "ConversationSession": "agent_core.conversation_session",
    "DEGRADED_REPLY": "agent_core._shared",
    "_current_request_ctx": "agent_core._shared",
    "StickerManager": "emotion.sticker_manager",
    ...
    "FileReceiver": "utils.file_receiver",
