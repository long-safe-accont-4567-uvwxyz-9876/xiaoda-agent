...
onMounted(async () => {
  ...
  try {
    ...
    keys.value = [
      { key: 'MIMO_API_KEY', label: t('setupWizard.fallback.MIMO_API_KEY.label'), desc: t('setupWizard.fallback.MIMO_API_KEY.desc'), url: 'https://platform.xiaomimimo.com?ref=A54DLY', url_desc: t('setupWizard.fallback.MIMO_API_KEY.url_desc'), required: true, configured: false, masked_value: '', raw_value: '' },
      ...
      { key: 'SILICONFLOW_API_KEY', label: t('setupWizard.fallback.SILICONFLOW_API_KEY.label'), desc: t('setupWizard.fallback.SILICONFLOW_API_KEY.desc'), url: 'https://cloud.siliconflow.cn/i/iM5RmeWc', url_desc: t('setupWizard.fallback.SILICONFLOW_API_KEY.url_desc'), required: false, configured: false, masked_value: '', raw_value: '' },
