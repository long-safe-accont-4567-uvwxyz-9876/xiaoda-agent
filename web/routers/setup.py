...
【一、版权声明】
1. 原神 IP 版权归属：本项目中涉及的「原神」「Genshin Impact」及其角色名称、形象、设定、语音、表情素材等知识产权均归米哈游（miHoYo / HoYoverse）所有。本项目为个人学习用途的非官方二次创作，与米哈游不存在任何隶属、授权或合作关系。本项目不侵犯原作版权，亦不代表原作立场。
...
【五、反馈与侵权处理】
12. 侵权投诉：如您认为本项目中存在侵犯您版权、肖像权或其他合法权益的内容，请通过 GitHub Issues 或 Gitee Issues 联系开发者，开发者将在 24 小时内核实并删除相关内容。
