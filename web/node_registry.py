"""桥接 shim — 实现已下沉 core_runtime/node_registry.py（H1 分层下沉 2026-08-27）。

本模块所有属性读写（含测试 monkeypatch 的符号如 resolve_and_pin/_cache）
实时转发 core_runtime 真身：普通 from-import 快照语义会让 web 层与
core_runtime 名字分叉，patch 失效。新代码请直接 import core_runtime.node_registry。
"""
from types import ModuleType

from core_runtime import node_registry as _impl
