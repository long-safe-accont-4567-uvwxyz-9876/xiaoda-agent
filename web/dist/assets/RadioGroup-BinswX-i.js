...
`,[C("splitor",`
 ...
 `),D("checked",{color:"var(--n-button-text-color-hover)"})]),S("focus",[V("&:not(:active)",[C("state-border",{boxShadow:"var(--n-button-box-shadow-focus)"})])])]),S("checked",`
