...
`,[u("strong",`
 ...
 `,[I("disabled",[z("&:hover","background-color: var(--n-color-checked-hover);"),z("&:active","background-color: var(--n-color-checked-pressed);")])])])]),So=Object.assign(Object.assign(Object.assign({},K.props),Io),{bordered:{type:Boolean,default:void 0},checked:Boolean,checkable:Boolean,strong:Boolean,triggerClickOnClose:Boolean,onClose:[Array,Function],onMouseenter:Function,onMouseleave:Function,"onUpdate:checked":Function,onUpdateChecked:Function,internalCloseFocusable:{type:Boolean,default:!0},internalCloseIsButtonTag:{type:Boolean,default:!0},onCheckedChange:Function}),Bo=xo("n-tag"),Ho=ho({name:"Tag",props:So,slots:Object,setup(a){const g=uo(null),{mergedBorderedRef:r,mergedClsPrefixRef:p,inlineThemeDisabled:c,mergedRtlRef:i,mergedComponentPropsRef:n}=bo(a),s=w(()=>{var o,l;return a.size||((l=(o=n==null?void 0:n.value)===null||o===void 0?void 0:o.Tag)===null||l===void 0?void 0:l.size)||"medium"}),t=K("Tag","-tag",zo,yo,a,p);ko(Bo,{roundRef:mo(a,"round")});function f(){if(!a.disabled&&a.checkable){const{checked:o,onCheckedChange:l,onUpdateChecked:C,"onUpdate:checked":h}=a;C&&C(!o),h&&h(!o),l&&l(!o)}}function k(o){if(a.triggerClickOnClose||o.stopPropagation(),!a.disabled){const{onClose:l}=a;l&&po(l,o)}}const b={setTextContent(o){const{value:l}=g;l&&(l.textContent=o)}},S=Co("Tag",i,p),P=w(()=>{const{type:o,color:{color:l,textColor:C}={}}=a,h=s.value,{common:{cubicBezierEaseInOut:B},self:{padding:$,closeMargin:H,borderRadius:R,opacityDisabled:M,textColorCheckable:T,textColorHoverCheckable:_,textColorPressedCheckable:E,textColorChecked:O,colorCheckable:W,colorHoverCheckable:j,colorPressedCheckable:L,colorChecked:V,colorCheckedHover:A,colorCheckedPressed:J,closeBorderRadius:Q,fontWeightStrong:X,[d("colorBordered",o)]:Z,[d("closeSize",h)]:q,[d("closeIconSize",h)]:G,[d("fontSize",h)]:Y,[d("height",h)]:F,[d("color",o)]:oo,[d("textColor",o)]:eo,[d("border",o)]:ro,[d("closeIconColor",o)]:N,[d("closeIconColorHover",o)]:lo,[d("closeIconColorPressed",o)]:ao,[d("closeColorHover",o)]:co,[d("closeColorPressed",o)]:no}}=t.value,y=fo(H);return{"--n-font-weight-strong":X,"--n-avatar-size-override":`calc(${F} - 8px)`,"--n-bezier":B,"--n-border-radius":R,"--n-border":ro,"--n-close-icon-size":G,"--n-close-color-pressed":no,"--n-close-color-hover":co,"--n-close-border-radius":Q,"--n-close-icon-color":N,"--n-close-icon-color-hover":lo,"--n-close-icon-color-pressed":ao,"--n-close-icon-color-disabled":N,"--n-close-margin-top":y.top,"--n-close-margin-right":y.right,"--n-close-margin-bottom":y.bottom,"--n-close-margin-left":y.left,"--n-close-size":q,"--n-color":l||(r.value?Z:oo),"--n-color-checkable":W,"--n-color-checked":V,"--n-color-checked-hover":A,"--n-color-checked-pressed":J,"--n-color-hover-checkable":j,"--n-color-pressed-checkable":L,"--n-font-size":Y,"--n-height":F,"--n-opacity-disabled":M,"--n-padding":$,"--n-text-color":C||eo,"--n-text-color-checkable":T,"--n-text-color-checked":O,"--n-text-color-hover-checkable":_,"--n-text-color-pressed-checkable":E}}),v=c?vo("tag",w(()=>{let o="";const{type:l,color:{color:C,textColor:h}={}}=a;return o+=l[0],o+=s.value[0],C&&(o+=`a${D(C)}`),h&&(o+=`b${D(h)}`),r.value&&(o+="c"),o}),P,a):void 0;return Object.assign(Object.assign({},b),{rtlEnabled:S,mergedClsPrefix:p,contentRef:g,mergedBordered:r,handleClick:f,handleCloseClick:k,cssVars:c?void 0:P,themeClass:v==null?void 0:v.themeClass,onRender:v==null?void 0:v.onRender})},render(){var a,g;const{mergedClsPrefix:r,rtlEnabled:p,closable:c,color:{borderColor:i}={},round:n,onRender:s,$slots:t}=this;s==null||s();const f=U(t.avatar,b=>b&&x("div",{class:`${r}-tag__avatar`},b)),k=U(t.icon,b=>b&&x("div",{class:`${r}-tag__icon`},b));return x("div",{class:[`${r}-tag`,this.themeClass,{[`${r}-tag--rtl`]:p,[`${r}-tag--strong`]:this.strong,[`${r}-tag--disabled`]:this.disabled,[`${r}-tag--checkable`]:this.checkable,[`${r}-tag--checked`]:this.checkable&&this.checked,[`${r}-tag--round`]:n,[`${r}-tag--avatar`]:f,[`${r}-tag--icon`]:k,[`${r}-tag--closable`]:c}],style:this.cssVars,onClick:this.handleClick,onMouseenter:this.onMouseenter,onMouseleave:this.onMouseleave},k||f,x("span",{class:`${r}-tag__content`,ref:"contentRef"},(g=(a=this.$slots).default)===null||g===void 0?void 0:g.call(a)),!this.checkable&&c?x(go,{clsPrefix:r,class:`${r}-tag__close`,disabled:this.disabled,onClick:this.handleCloseClick,focusable:this.internalCloseFocusable,round:n,isButtonTag:this.internalCloseIsButtonTag,absolute:!0}):null,!this.checkable&&this.mergedBordered?x("div",{class:`${r}-tag__border`,style:{borderColor:i}}):null)}});export{Ho as N,Io as c,yo as t};
