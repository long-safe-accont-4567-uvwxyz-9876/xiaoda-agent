import{bm as We,e6 as qe,a7 as D,a9 as n,aa as b,ab as j,b2 as he,dV as Ge,dW as Je,cF as Qe,d as Ze,R as f,bs as eo,T as oo,Y as ao,af as ge,b5 as to,r as k,s as fe,q as no,ah as ve,ae as ro,f as p,ak as O,aY as U,a$ as _,aq as Z,am as io}from"./index-BOjOLFsl.js";import{B as lo,V as so,a as co,b as ee,u as uo}from"./Suffix-CxwoR6DJ.js";function ho(t){const i="rgba(0, 0, 0, .85)",y="0 2px 8px 0 rgba(0, 0, 0, 0.12)",{railColor:v,primaryColor:s,baseColor:d,cardColor:z,modalColor:R,popoverColor:Y,borderRadius:L,fontSize:M,opacityDisabled:B}=t;return Object.assign(Object.assign({},qe),{fontSize:M,markFontSize:M,railColor:v,railColorHover:v,fillColor:s,fillColorHover:s,opacityDisabled:B,handleColor:"#FFF",dotColor:z,dotColorModal:R,dotColorPopover:Y,handleBoxShadow:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowHover:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowActive:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowFocus:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",indicatorColor:i,indicatorBoxShadow:y,indicatorTextColor:d,indicatorBorderRadius:L,dotBorder:`2px solid ${v}`,dotBorderActive:`2px solid ${s}`,dotBoxShadow:""})}const fo={common:We,self:ho},vo=D([n("slider",`
 display: block;
