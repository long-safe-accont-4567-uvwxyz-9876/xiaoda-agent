...
REEXPORT_NAMES = [
    ...
    "STREAM_TEXT_PUSH", "STREAM_TOOL_STATUS", "STRUCTURED_STREAM_EVENTS",
    "GROUP_CHAT_BUFFER_ENABLED", "MEMORY_RECONCILIATION_MODE",
    ...
    "RAG_VEC_MAX_DISTANCE", "RAG_VEC_SOFT_PENALTY", "RAG_RRF_RANK_PENALTY",
    "FTS_DROP_CJK_SINGLE",
    "FTS_CJK_STOP_WORDS_FILTER",
...
_ENV_DEFAULTS = {
    ...
    "STRUCTURED_STREAM_EVENTS": ("STRUCTURED_STREAM_EVENTS", False),
    "GROUP_CHAT_BUFFER_ENABLED": ("GROUP_CHAT_BUFFER_ENABLED", False),
    "MEMORY_RECONCILIATION_MODE": ("MEMORY_RECONCILIATION_MODE", "shadow"),
    ...
    "QUERY_EXPAND_COUNT": ("QUERY_EXPAND_COUNT", 0),
    ...
    "RAG_RERANK_WEIGHT": ("RAG_RERANK_WEIGHT", 0.60),
    "RAG_KG_WEIGHT": ("RAG_KG_WEIGHT", 0.10),
    "RAG_IMPORTANCE_WEIGHT": ("RAG_IMPORTANCE_WEIGHT", 0.10),
    "RAG_RECALL_LIMIT": ("RAG_RECALL_LIMIT", 120),
    "RAG_RERANK_LIMIT": ("RAG_RERANK_LIMIT", 60),
    "RAG_MIN_FINAL_SCORE": ("RAG_MIN_FINAL_SCORE", 0.08),
        "RAG_VEC_MAX_DISTANCE": ("RAG_VEC_MAX_DISTANCE", 1.15),
    "RAG_VEC_SOFT_PENALTY": ("RAG_VEC_SOFT_PENALTY", 0.6),
    "RAG_RRF_RANK_PENALTY": ("RAG_RRF_RANK_PENALTY", 1.0),
    "FTS_DROP_CJK_SINGLE": ("FTS_DROP_CJK_SINGLE", False),
    "FTS_CJK_STOP_WORDS_FILTER": ("FTS_CJK_STOP_WORDS_FILTER", False),
