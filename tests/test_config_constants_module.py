...
_ENV_DEFAULTS = {
    ...
    "MEMORY_RETRIEVAL_DIFFUSION": ("MEMORY_RETRIEVAL_DIFFUSION", False),
    # 数值/阈值（默认值）
    ...
    "RAG_RECALL_LIMIT": ("RAG_RECALL_LIMIT", 50),
    "RAG_RERANK_LIMIT": ("RAG_RERANK_LIMIT", 50),
    "RAG_MIN_FINAL_SCORE": ("RAG_MIN_FINAL_SCORE", 0.15),
    "RAG_VEC_MAX_DISTANCE": ("RAG_VEC_MAX_DISTANCE", 1.0),
    ...
    "MEMORY_WARM_VEC_WEIGHT": ("MEMORY_WARM_VEC_WEIGHT", 0.2),
