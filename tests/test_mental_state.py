...
# ── 情绪语气引导（2026-08 review 二轮 Fix A：枚举归一替代手抄集合）──


class TestEmotionGuidance:
    @pytest.mark.parametrize("user_emotion,expected", [
        # 规范标签
        ("焦虑", "安抚"), ("悲伤", "安抚"), ("愤怒", "安抚"),
        ("恐惧", "安抚"), ("困惑", "安抚"),
        ("喜悦", "轻快"), ("兴奋", "轻快"), ("喜爱", "轻快"),
        ...
        ("平静", "温柔"), ("好奇", "温柔"), ("问候", "温柔"),
        # 关键词变体（此前手抄集合覆盖不到的）
        ("烦躁", "安抚"), ("委屈", "安抚"), ("迷茫", "安抚"), ("孤独", "安抚"),
        ("开心", "轻快"), ("暖心", "轻快"),
        # emotion_llm 自由文本兜底
        ("", "温柔"), ("完全未知的情绪", "温柔"),
    ])
    def test_guidance_classification(self, user_emotion, expected):
        assert MentalStateManager._emotion_guidance(user_emotion) == expected

    def test_guidance_soothing_beats_default_for_canonical_confused(self):
        """回归锚点：规范标签"困惑"曾因不在手抄集合而错落"温柔\""""
        assert MentalStateManager._emotion_guidance("困惑") == "安抚"
