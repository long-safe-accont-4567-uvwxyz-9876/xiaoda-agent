...
from config_constants import (  # noqa: F401,E402
    ...
    GROUP_REPLY_PERSONAL_MEMORY_ENABLED,
    HYDE_ENABLED,
    HYDE_SUBSET_MODE,
    ...
    JEV_ENABLED,
    JEV_MIN_CONFIDENCE_INTENT,
    JEV_MIN_CONFIDENCE_ROUTE,
    JEV_MODEL,
    JEV_RELEVANCE_DROP_BELOW,
    JEV_RISK_ALLOW_THRESHOLD,
    JEV_RISK_DENY_THRESHOLD,
    JEV_TIMEOUT,
    ...
    MEMORY_EVIDENCE_TOKEN_BUDGET,
    MEMORY_RECONCILIATION_ALLOWED_ACTIONS,
    MEMORY_RECONCILIATION_MODE,
    MEMORY_RECONCILIATION_WORKER_ENABLED,
    MEMORY_RECONCILIATION_WORKER_INTERVAL,
    MEMORY_RETRIEVAL_DIFFUSION,
    MEMORY_RETRIEVE_TIMEOUT,
    MEMORY_TYPE_ENRICHMENT_ENABLED,
    MEMORY_WARM_MAX,
    ...
    RAG_RERANK_LIMIT,
    RAG_RERANK_WEIGHT,
    RAG_RRF_RANK_PENALTY,
    RAG_VEC_MAX_DISTANCE,
    RAG_VEC_SOFT_PENALTY,
    RERANKER_BASE_URL,
    RERANKER_ENABLED,
    RERANKER_MODEL,
...
__all__ = [
    # 2026-08-23 清理: 删除 AGENT_CONFIG/AGNES_API_KEY 等 7 个已随配置拆分
    # 迁走/懒加载化但残留于 __all__ 的死条目(F822)
    "AGENTS_CONFIG_DIR",
    "AGENT_CONFIG_PATH",
    "CONFIG_DIR",
    "AGENT_STICKER_BASE",
