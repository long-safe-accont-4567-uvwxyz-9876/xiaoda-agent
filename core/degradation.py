...
# ── 兼容枚举：直接复用新版 DegradationLevel，旧名映射到新名 ──
DegradationLevel = _NewLevel

# 旧版名称 → 新版枚举值 的兼容映射（供代码中用旧名引用）
FULL = _NewLevel.L0_NORMAL
DEGRADED = _NewLevel.L1_DEGRADED
MINIMAL = _NewLevel.L2_MINIMAL
EMERGENCY = _NewLevel.L3_EMERGENCY
