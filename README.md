...
1. **原神 IP 版权归属**：本项目中涉及的「原神」「Genshin Impact」及其角色名称、形象、设定、语音、表情素材等知识产权均归 **米哈游（miHoYo / HoYoverse）** 所有。本项目为个人学习用途的非官方二次创作，**与米哈游不存在任何隶属、授权或合作关系**。本项目不侵犯原作版权，亦不代表原作立场。
2. **角色素材使用**：项目中使用的角色表情包、头像、语音素材等均来源于社区公开资源，仅用于个人学习研究，不用于商业目的。如版权方认为存在侵权，请联系开发者，开发者将在 **24 小时内删除** 相关内容。
3. **代码版权**：本项目的全部代码、架构设计、文档由开发者"飞"独立编写，保留所有权利。代码以 MIT 协议开源，但项目名称、品牌标识（"Xiaoda Agent"、"小妲"等）不在 MIT 授权范围内。
...
12. **侵权投诉**：如您认为本项目中存在侵犯您版权、肖像权或其他合法权益的内容，请通过以下方式联系开发者，开发者将在 **24 小时内核实并删除** 相关内容：
    - **GitHub Issues**：https://github.com/long-safe-accont-4567-uvwxyz-9876/xiaoda-agent/issues
    - **Gitee Issues**：https://gitee.com/liu-runfe/xiaoda-agent/issues
    - **开发者邮箱**：请通过 GitHub Profile 获取联系方式
13. **意见与建议**：如果您对本项目有任何不满、建议或改进意见，欢迎随时通过上述渠道反馈，开发者将认真对待每一条意见并及时回应。
14. **内容下架**：开发者尊重原创版权与用户感受，如收到合理的下架请求，将在确认后立即删除相关资源，无需额外法律程序。

### 六、第三方依赖

15. **第三方服务免责**：本软件集成的第三方模型服务、MCP 服务、插件、表情素材、agently-cli 邮箱能力等组件，其服务条款、计费规则、可用性、政策变更及合规风险均由对应第三方主体负责。开发者对第三方服务的稳定性、连续性、合法性不承担任何责任，因第三方服务中断、变更、合规问题等造成的损失由用户自行承担。
